...
import { fetchHistorylist, loadingStart } from "../../redux/actions/history";
...
class History extends Component {
    ...
    async historylist() {
        const { fetchHistorylist, loadingStart } = this.props;
        loadingStart();
    ...
    renderItem = ({ item }) => {
        return (
            <View>
                <TouchableOpacity key={item} onPress={(item) => this.props.navigation.navigate('historySchedule', { historyData:[item], paramKey1: item.id })}>
                    ...
                    <Row style={styleCss.nutrition_list_row}>
                        ...
                        <Col style={styleCss.nutrition_list_details_col}>
                            <Row style={styleCss.nutrition_list_details_row}>
                                <Text style={styleCss.nutrition_list_details_label}>{t("Date")}: </Text>
                                <Text style={styleCss.nutrition_list_details_text}>{item.updated_date}</Text>
                            </Row>

                            <Row style={styleCss.nutrition_list_details_row}>
                                <Text style={styleCss.nutrition_list_details_label}></Text>
                                <Text style={styleCss.nutrition_list_details_text}>{item.carryout_status}</Text>
                            </Row>
                        </Col>
                    </Row>
                ...
                <View style={styleCss.container}>
                    ...
                    <Row style={styleCss.NaveBar}>
                        ...
                        <Col style={styleCss.nutrition_list_name_col}>
                            <Text style={styleCss.NaveText}>{t("History")}</Text>
                        </Col>
...
const mapStateToProps = (state) => {
    return {
        Data: state.history.historyData,
